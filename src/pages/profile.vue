    ...
    <div class="bg-white shadow-lg rounded-lg p-8  flex flex-col items-center">
      ...
      <form @submit.prevent="updateUser" class="  gap-4 items-center justify-items-end">
        ...
        <div class="m-6">
          ...
          <input type="text" id="name" v-model="localUser.name" placeholder="نام خود را وارد کنید"
        ...
        <div class="m-6">
          ...
          <input disabled type="email" id="email" v-model="localUser.email"
        ...
        <div class="m-6">
          ...
          <input disabled type="text" id="creationAt" v-model="authStore.user.creationAt"
            class="mt-1 block w-50 px-3 py-2 border text-gray-400/95 border-gray-300 rounded-md shadow-sm" />
        </div>
